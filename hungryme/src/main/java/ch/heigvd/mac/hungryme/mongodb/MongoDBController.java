...
public class MongoDBController implements DocumentDatabase {
    ...
    public Recipe getRecipeById(String id) {
        ...
        if(recipeDocument == null) {
            ...
            Recipe recipe = new Recipe((String) recipeDocument.get("_id"), (String) recipeDocument.get("name"));
            ...
            for (Document ingredientDocument: (Collection<Document>)recipeDocument.get("ingredients")) {
                recipe.addIngredient(
                        new Ingredient(
                                ...
                                Double.parseDouble((String) ingredientDocument.get("quantity")),
                                (String) ingredientDocument.get("name")
                        )
                );
            }

            for (Document tagDocument : (Collection<Document>)recipeDocument.get("tags")) {
                recipe.addTag(tagDocument.toString());
            }
